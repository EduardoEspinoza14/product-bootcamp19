...
public class KafkaProducerConfiguration {
  ...
  public static Flux<SenderResult<Long>> senderCreate(SenderOptions<String,
          ProductMongo> options, SenderRecord<String, ProductMongo, Long> record) {
  ...
  private static SenderRecord<String, ProductMongo, Long> senderRecord(String id,
  ...
  private static SenderRecord<String, ProductMongo, Long> senderRecord(ProductMongo productMongo,
                                                                       String topic) {
